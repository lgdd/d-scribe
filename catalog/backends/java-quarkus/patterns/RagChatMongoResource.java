...
public class RagChatMongoResource {
    ...
    public Map<String, Object> chat(Map<String, Object> body) throws Exception {
        ...
        MongoCollection<Document> docsColl = mongo.getDatabase("demo").getCollection("documents");
        LLMObsSpan wf = LLMObs.startWorkflowSpan("rag-chat-mongo");
        try {
            String queryVec = embedQuery(userMsg);
            List<Map<String, Object>> sources = searchDocs(docsColl, queryVec);
    ...
    private List<Map<String, Object>> searchDocs(MongoCollection<Document> docsColl, String queryVec) {
