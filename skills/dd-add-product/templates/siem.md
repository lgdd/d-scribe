...
For K8s audit logs, use file-based log collection — mount the audit log file into the Agent and configure a log collection YAML. See [Kubernetes Audit Logs](https://docs.datadoghq.com/integrations/kubernetes_audit_logs/) for the setup steps.
