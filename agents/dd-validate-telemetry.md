...
| Schema collection / DBM not fully enabled for Postgres | collect_schemas missing or Agent too old | Use the latest Agent image (`gcr.io/datadoghq/agent:latest`) and add `"collect_schemas": true` to the postgres check instance |
